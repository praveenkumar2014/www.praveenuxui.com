...
<div class="top-info"><div class="text"><h1 class="main-title">Read My Latest <span>Articles</span></h1></div></div>
<div class="blog-area">
<div class="row g-4">
<?php if(empty($all_blogs)): ?>
    <div class="col-lg-12 text-center py-5"><p class="text-secondary">No blog posts yet.</p></div>
<?php else: ?>
    <?php foreach($all_blogs as $blog): ?>
    <div class="col-lg-6">
        <div class="blog-item card h-100 bg-transparent border-0">
            <div class="image mb-3">
                <img loading="lazy" src="<?php echo $blog['image']; ?>" alt="<?php echo $blog['title']; ?>" class="img-fluid rounded-4">
            </div>
            <div class="text">
                <div class="meta mb-2 d-flex gap-3 small text-secondary">
                    <span><i class="far fa-calendar-alt me-1"></i> <?php echo $blog['date']; ?></span>
                    <span><i class="far fa-folder me-1"></i> <?php echo $blog['category']; ?></span>
                </div>
                <h3 class="title h5 mb-3"><a href="article?id=<?php echo $blog['id']; ?>" class="text-white text-decoration-none"><?php echo $blog['title']; ?></a></h3>
                <a href="article?id=<?php echo $blog['id']; ?>" class="link-btn small text-primary text-decoration-none">Read More <i class="fas fa-arrow-right ms-1"></i></a>
            </div>
        </div>
    </div>
    <?php endforeach; ?>
