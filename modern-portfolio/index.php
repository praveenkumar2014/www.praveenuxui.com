...
$latest_projects = fetch_projects(3);
$skills = fetch_skills();
?>
  ...
  <section class="home-area">
    <div class="container">
      <div class="row g-4">
        ...
        <?php
        require_once 'includes/db_fetch.php';
        $dynamic_projects = fetch_projects(4);
        ?>
        <div class="col-xl-4">
          <div class="card card-projects">
            <div class="card-body">
              ...
              <div class="projects-main mt-24">
                <div class="row g-4 parent-container" id="projects-container">
                  <!-- Loaded via JS -->
                </div>
              </div>
            </div>
