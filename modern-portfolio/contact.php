                ...
                <div class="card-body">
                  ...
                  <h3 class="card-title">Praveen Kumar K 👋</h3>
                    ...
                    <div class="common-button-groups">
                      <a class="btn btn-call" href="#booking-section">
...
<li><a href="#" onclick="event.preventDefault();alert('Job Offer? Telegram: +918884263999');window.open('https://t.me/+918884263999','_blank');" title="Telegram"><i class="fab fa-telegram" style="color:#0088cc"></i></a></li>
            ...
            <div class="col-xl-8">
              <div class="card content-box-card">
                <div class="card-body portUXUI-card contact-card">
                  <div class="top-info">
                    <div class="text">
                  ...
                  <div class="contact-area">
                    ...
                    <div class="booking-section" id="booking-section">
                      ...
                      <div class="booking-slots">
                        ...
                        <button class="slot-btn" onclick="selectSlot(this)">Mon 3:00 PM IST</button>
                        <button class="slot-btn" onclick="selectSlot(this)">Tue 11:00 AM IST</button>
                        <button class="slot-btn" onclick="selectSlot(this)">Wed 10:00 AM IST</button>
                        <button class="slot-btn" onclick="selectSlot(this)">Wed 4:00 PM IST</button>
                        <button class="slot-btn" onclick="selectSlot(this)">Thu 2:00 PM IST</button>
                        <button class="slot-btn" onclick="selectSlot(this)">Fri 11:00 AM IST</button>
                        <button class="slot-btn" onclick="selectSlot(this)">Fri 5:00 PM IST</button>
                      </div>
                      <button class="slot-confirm-btn" onclick="confirmBooking()">
                    ...
                    function confirmBooking() {
                        ...
                        const msg = encodeURIComponent(`Hi Praveen, I would like to book a discovery call for: ${selectedSlotText}. Please confirm if you are available.`);
