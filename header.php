          ...
          <div class="menu-container">
            <div class="logo">
              <a class="navbar-brand me-0" href="index.php">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path id="Subtraction_33" data-name="Subtraction 33" d="M8854.994-14410a13.852,13.852,0,0,1-4.824-.864c-.347-.128-.627-.24-.883-.357l-.049-.022c-.02-.008-.04-.019-.062-.028l-.1-.047-.082-.041-.084-.041c-.027-.011-.043-.019-.043-.019a13.912,13.912,0,0,1-7.1-8.021,13.9,13.9,0,0,1,.651-10.691,13.97,13.97,0,0,1,5.263-5.8,14.046,14.046,0,0,1,7.331-2.068,13.861,13.861,0,0,1,6.124,1.421c.146.072.242.12.33.166l.019.01.012.006.017.009a14,14,0,0,1,7.463,13.147c0,.051,0,.1-.007.164v.016l0,.032v.009c0,.034-.006.068-.008.1a.1.1,0,0,1,0,.016.227.227,0,0,0,0,.023l0,.035,0,.03c0,.021,0,.043,0,.063a.146.146,0,0,1,0,.043c0,.019,0,.04-.007.061s0,.04,0,.06a.16.16,0,0,1,0,.022c0,.014,0,.022,0,.035,0,.031-.007.064-.011.1v.011a.31.31,0,0,0-.009.066c0,.03-.008.062-.011.093l-.007.042-.006.043c0,.02,0,.036-.008.054v.006l0,.02c0,.026-.007.054-.011.082v.011l0,.03-.006.03,0,.011,0,.014a.764.764,0,0,1-.014.091v.012l0,.012a.3.3,0,0,1,0,.031c0,.017-.007.033-.01.05v.008a.431.431,0,0,1-.01.059v.009l0,.012a.263.263,0,0,1,0,.027c-.009.039-.016.081-.023.123a.1.1,0,0,1,0,.027v.006l0,.006-.012.066-.012.066a.056.056,0,0,0,0,.027.625.625,0,0,0-.014.062c0,.027-.011.053-.018.079a.067.067,0,0,1,0,.013v0l0,.019-.012.057c0,.026-.01.052-.017.077a.017.017,0,0,0,0,.013c-.012.054-.023.1-.034.155l0,0a.016.016,0,0,0,0,.008l0,.023-.006.028c-.009.035-.018.07-.027.1-.012.06-.028.117-.043.167a14.163,14.163,0,0,1-.971,2.617,13.918,13.918,0,0,1-5.255,5.794A14.029,14.029,0,0,1,8854.994-14410Zm.813-9.756h0l.338,5.1,3.064,1.487-.708-7.741,5.933-2.974-3.191-1.559-3.958,2.235-1.56.923,2.306-4.726-.043-.023c.007-.015.016-.029.022-.044s.027-.051.04-.077a3.854,3.854,0,0,0,.4-2.114,3.734,3.734,0,0,0-.821-1.97,5.444,5.444,0,0,0-1.924-1.491l-4.207-2.053-6.2,12.712,3.636-1,1.705-3.5,1.623.791a6.951,6.951,0,0,0,1.686.58l-3.729,7.649,2.585,1.262,1.379-2.826,1.626-.646Zm-1.641-7.722a2.089,2.089,0,0,1-.905-.24l-1.666-.814,1.482-3.04,1.7.825a1.572,1.572,0,0,1,.864.981,1.888,1.888,0,0,1-.175,1.374,1.532,1.532,0,0,1-.9.853A1.368,1.368,0,0,1,8854.166-14427.479Z" transform="translate(-8840.935 14438.063)"
                    class="logo-icon" />
                </svg>
            ...
            <div class="navbar-main d-flex flex-grow-1">
              ...
              <ul class="navbar-info mx-auto">
                <li class="nav-item">
                  <a class="nav-link<?php echo nav_active('index.php'); ?>" aria-current="page" href="index.php">
                ...
                <li class="nav-item">
                  <a class="nav-link<?php echo nav_active('about.php'); ?>" href="about.php">
                ...
                <li class="nav-item">
                  <a class="nav-link<?php echo nav_active('services.php'); ?>" href="services.php">
                ...
                <li class="nav-item">
                  <a class="nav-link<?php echo nav_active('portfolio.php'); ?>" href="portfolio.php">
                ...
                <li class="nav-item">
                  <a class="nav-link<?php echo nav_active('blog.php'); ?>" href="blog.php">
                ...
                <li class="nav-item">
                  <a class="nav-link<?php echo nav_active('contact.php'); ?>" href="contact.php">
                    <svg class="nav-icon" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="header-right-info d-flex align-items-center">
                ...
                <a href="contact.php" class="lets-talk-btn">
                  Let's Talk
