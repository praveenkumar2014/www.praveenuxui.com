                ...
                <div class="card-body portUXUI-card">
                  <div class="portUXUI-details-area">
                    <div class="main-image">
                      <img loading="lazy" src="assets/img/projects/project-details-1.png" alt="project-details-1">
                    </div>
                      ...
                      <div class="row g-3">
                        <div class="col-md-6">
                          <div class="image-item">
                            <img loading="lazy" src="assets/img/projects/project-details-2.png" alt="project-details-2"
                              class="img-fluid w-100">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="image-item">
                            <img loading="lazy" src="assets/img/projects/project-details-3.png" alt="project-details-3"
                              class="img-fluid w-100">
                          </div>
                        </div>
                      </div>
